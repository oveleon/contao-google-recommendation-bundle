...
<p align="center">
    ...
    <a href="https://github.com/oveleon/contao-google-recommendation-bundle"><img src="https://img.shields.io/badge/license-MIT-83aa0e?style=flat-square"/></a>
    <a href="https://packagist.org/packages/oveleon/contao-recommendation-bundle"><img src="https://img.shields.io/packagist/dt/oveleon/contao-google-recommendation-bundle?color=0A7BBC&style=flat-square"/></a>
</p>
<br/>
...
<table>
  <tr>
    <th colspan="2"><strong>Google Reviews</strong></th>
  </tr>
  <tr>
  ...
  <tr>
    <td>Sync with Google</td>
    <td>Activate to enable synchronization with Google API</td>
  </tr>
  <tr>
    <td>Google API Token</td>
    <td>Your Google API Token. More information on Google: <a href="https://cloud.google.com/docs/authentication/api-keys">Using API keys</a></td>
  </tr>
  <tr>
    <td>Google Places ID</td>
    <td>Your Google Place ID. More information on Google: <a href="https://developers.google.com/maps/documentation/places/web-service/place-id">Place IDs</a></td>
  </tr>
  <tr>
    <td>Language</td>
